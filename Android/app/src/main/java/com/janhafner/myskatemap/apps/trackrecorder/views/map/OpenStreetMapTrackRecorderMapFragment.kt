...
internal final class OpenStreetMapTrackRecorderMapFragment : Fragment(), ITrackRecorderMap {
    ...
    public override fun zoomToLocation(location: SimpleLocation, zoom: Float) {
        val points = arrayListOf(GeoPoint(location.latitude, location.longitude))
