...
internal final class CurrentAmbientTemperatureDashboardTileFragmentPresenter(view: DashboardTileFragment,
    ...
    public override fun initialize() {
        // TODO
        this.view.fragment_dashboard_tile_title.text = "Temperatur"
    }
    ...
    protected override fun createSubscriptions(trackRecorderSession: ITrackRecordingSession): List<Disposable> {
        ...
        result.add(
                trackRecorderSession.statistic.ambientTemperature.lastValueChanged
                        .map {
                            it.toString()
                        }
