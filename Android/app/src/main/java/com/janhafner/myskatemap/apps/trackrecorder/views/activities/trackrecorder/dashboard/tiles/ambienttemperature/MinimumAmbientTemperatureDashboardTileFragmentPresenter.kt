...
internal final class MinimumAmbientTemperatureDashboardTileFragmentPresenter(view: DashboardTileFragment,
    ...
    public override fun initialize() {
        // TODO
        this.view.fragment_dashboard_tile_title.text = "minimum Temperatur"
    }
    ...
    protected override fun createSubscriptions(trackRecorderSession: ITrackRecordingSession): List<Disposable> {
        ...
        result.add(
                trackRecorderSession.statistic.ambientTemperature.minimumValueChanged
                        .map {
                            it.toString()
                        }
