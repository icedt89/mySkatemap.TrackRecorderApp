package com.janhafner.myskatemap.apps.trackrecorder.views.activities.trackrecorder.dashboard.tiles.recordingtime
...
internal final class RecordingTimeDashboardTileFragmentPresenter(private val context: Context,
    ...
    init {
        val title = this.context.getString(R.string.dashboard_tile_recordingtimedashboardtilefragmentpresenter_tile)
