package com.janhafner.myskatemap.apps.trackrecorder.views.activities.trackrecorder.map.neu
...
import com.janhafner.myskatemap.apps.trackrecorder.views.map.neu.ITrackRecorderMapFragmentFactory
...
internal final class MapTabFragmentPresenter(private val view: MapTabFragment,
    ...
    public override fun onMapReady(trackRecorderMap: ITrackRecorderMap) {
        ...
        trackRecorderMap.trackColor = this.view.context!!.getColor(R.color.primaryColor)
