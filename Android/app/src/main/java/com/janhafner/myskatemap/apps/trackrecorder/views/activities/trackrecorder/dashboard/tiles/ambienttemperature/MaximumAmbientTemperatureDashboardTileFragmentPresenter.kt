...
internal final class MaximumAmbientTemperatureDashboardTileFragmentPresenter(view: DashboardTileFragment,
    ...
    public override fun initialize() {
        // TODO
        this.view.fragment_dashboard_tile_title.text = "maximum Temperatur"
    }
    ...
    protected override fun createSubscriptions(trackRecorderSession: ITrackRecordingSession): List<Disposable> {
        ...
        result.add(
                trackRecorderSession.statistic.ambientTemperature.maximumValueChanged
                        .map {
                            it.toString()
                        }
