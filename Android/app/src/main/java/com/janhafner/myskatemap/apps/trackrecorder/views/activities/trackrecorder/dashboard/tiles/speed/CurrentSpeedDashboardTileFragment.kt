...
internal final class CurrentSpeedDashboardTileFragment : DashboardTileFragment() {
    @Inject
    ...
    protected override fun createPresenter(): DashboardTileFragmentPresenter {
        return CurrentSpeedDashboardTileFragmentPresenter(this, this.appSettings, this.trackRecorderServiceController, this.speedUnitFormatterFactory)
    }
}
