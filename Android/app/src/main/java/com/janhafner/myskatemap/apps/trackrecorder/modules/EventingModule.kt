...
internal final class EventingModule {
    @Provides
    @Singleton
    public fun provideTrackRecordingEventsSubscriber(notifier: INotifier, trackQueryService: ITrackQueryService): TrackRecordingEventsSubscriber {
        return TrackRecordingEventsSubscriber(notifier, trackQueryService)
    }
