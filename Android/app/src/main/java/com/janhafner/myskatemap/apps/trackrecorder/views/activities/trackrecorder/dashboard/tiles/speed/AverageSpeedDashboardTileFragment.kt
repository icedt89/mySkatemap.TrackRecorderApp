...
internal final class AverageSpeedDashboardTileFragment : DashboardTileFragment() {
    @Inject
    ...
    protected override fun createPresenter(): DashboardTileFragmentPresenter {
        return AverageSpeedDashboardTileFragmentPresenter(this, this.appSettings, this.trackRecorderServiceController, this.speedUnitFormatterFactory)
    }
}