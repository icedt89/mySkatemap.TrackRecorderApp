...
internal final class MaximumAltitudeDashboardTileFragmentPresenter(view: DashboardTileFragment,
    ...
    public override fun initialize() {
        this.view.fragment_dashboard_tile_title.text = view.context!!.getString(R.string.dashboard_tile_maximumaltitudedashboardtilefragmentpresenter_title)
    }

    protected override fun getValueSourceObservable(trackRecorderSession: ITrackRecordingSession): Observable<Float> {
        return trackRecorderSession.statistic.altitude.maximumValueChanged
    }
}