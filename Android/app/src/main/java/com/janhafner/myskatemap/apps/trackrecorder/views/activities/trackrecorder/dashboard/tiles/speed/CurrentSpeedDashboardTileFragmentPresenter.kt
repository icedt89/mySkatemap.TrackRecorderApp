...
internal final class CurrentSpeedDashboardTileFragmentPresenter(view: DashboardTileFragment,
    ...
    public override fun initialize() {
        this.view.fragment_dashboard_tile_title.text = view.context!!.getString(R.string.dashboard_tile_currentspeeddashboardtilefragmentpresenter_tile)
    }

    protected override fun getValueSourceObservable(trackRecorderSession: ITrackRecordingSession): Observable<Float> {
        return trackRecorderSession.statistic.speed.lastValueChanged
    }
}
