...
internal final class AverageAmbientTemperatureDashboardTileFragmentPresenter(view: DashboardTileFragment,
    ...
    public override fun initialize() {
        // TODO
        this.view.fragment_dashboard_tile_title.text = "avg Temperatur"
    }
    ...
    protected override fun createSubscriptions(trackRecorderSession: ITrackRecordingSession): List<Disposable> {
        ...
        result.add(
                trackRecorderSession.statistic.ambientTemperature.averageValueChanged
                        .map {
                            it.toString()
                        }
