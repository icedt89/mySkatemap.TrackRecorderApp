...
private val activityRecordingTimeFormatter: PeriodFormatter = PeriodFormatterBuilder()
...
public fun Period.formatRecordingTime(): String {
    return activityRecordingTimeFormatter.print(this.normalizedStandard(PeriodType.time()))
}
