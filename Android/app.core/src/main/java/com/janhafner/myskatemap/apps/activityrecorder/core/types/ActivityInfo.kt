...
public final class ActivityInfo() : Parcelable {
    ...
    companion object CREATOR : Parcelable.Creator<ActivityInfo> {
        public override fun createFromParcel(parcel: Parcel): ActivityInfo {
            return ActivityInfo(parcel)
        }

        public override fun newArray(size: Int): Array<ActivityInfo?> {
